...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ProfitTrack — AI Profit Analyzer" },
      { name: "description", content: "Track daily sales vs cost, reconcile M-Pesa, and get AI profit insights for your food business." },
